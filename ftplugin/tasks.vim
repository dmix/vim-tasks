...
" MAPPINGS
nnoremap <buffer> <leader>Xn :call NewTask(1)<cr>
nnoremap <buffer> <leader>XN :call NewTask(-1)<cr>
nnoremap <buffer> <leader>Xd :call TaskComplete()<cr>
nnoremap <buffer> <leader>Xx :call TaskCancel()<cr>
nnoremap <buffer> <leader>Xa :call TasksArchive()<cr>
